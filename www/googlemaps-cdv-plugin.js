...
App.prototype.addPolyline = function (polylineOptions, callback) {
  ...
  }, self.errorHandler, PLUGIN_NAME, 'exec', ['PolylinePlugin.createPolyline', self.deleteFromObject(polylineOptions, 'function')]);
};
//-------------
// Polygon
//-------------
...
Polyline.prototype.setPoints = function (points) {
  ...
  cordova.exec(null, this.errorHandler, PLUGIN_NAME, 'exec', ['PolylinePlugin.setPoints', this.getId(), path]);
};
...
Polyline.prototype.setColor = function (color) {
  ...
  cordova.exec(null, this.errorHandler, PLUGIN_NAME, 'exec', ['PolylinePlugin.setColor', this.getId(), HTMLColor2RGBA(color, 0.75)]);
};
...
Polyline.prototype.setWidth = function (width) {
  ...
  cordova.exec(null, this.errorHandler, PLUGIN_NAME, 'exec', ['PolylinePlugin.setWidth', this.getId(), width]);
};
...
Polyline.prototype.setVisible = function (visible) {
  visible = parseBoolean(visible);
  this.set('visible', visible);
  cordova.exec(null, this.errorHandler, PLUGIN_NAME, 'exec', ['PolylinePlugin.setVisible', this.getId(), visible]);
};
...
Polyline.prototype.setGeodesic = function (geodesic) {
  ...
  cordova.exec(null, this.errorHandler, PLUGIN_NAME, 'exec', ['PolylinePlugin.setGeodesic', this.getId(), geodesic]);
};
...
Polyline.prototype.setZIndex = function (zIndex) {
  this.set('zIndex', zIndex);
  cordova.exec(null, this.errorHandler, PLUGIN_NAME, 'exec', ['PolylinePlugin.setZIndex', this.getId(), zIndex]);
};
Polyline.prototype.getZIndex = function () {
  return this.get('zIndex');
};
Polyline.prototype.remove = function () {
  cordova.exec(null, this.errorHandler, PLUGIN_NAME, 'exec', ['PolylinePlugin.remove', this.getId()]);
  this.off();
};
